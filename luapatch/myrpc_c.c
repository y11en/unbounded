 ...
 */
/* Compiler settings for myrpc.idl:
...
/* Standard interface: RPCServer, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO RPCServer_ProxyInfo;


static const RPC_CLIENT_INTERFACE RPCServer___RpcClientInterface =
    {
...
RPC_IF_HANDLE RPCServer_v1_0_c_ifspec = (RPC_IF_HANDLE)& RPCServer___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE RPCServer__MIDL_AutoBindHandle;
    ...
    /* [in] */ PMYSTRING msg)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&RPCServer_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  msg);
...
static const MIDL_STUB_DESC RPCServer_StubDesc = 
    {
    (void *)& RPCServer___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &RPCServer__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& RPCServer_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO RPCServer_ProxyInfo =
    {
    &RPCServer_StubDesc,
    myrpc__MIDL_ProcFormatString.Format,
    RPCServer_FormatStringOffsetTable,
